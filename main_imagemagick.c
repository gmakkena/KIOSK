...
// ---------- Only Updates GTK Images (safe from non-main thread) ----------
...
// ---------- Thread: Generate images in background then refresh UI ----------
